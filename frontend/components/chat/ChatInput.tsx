...
import { Paperclip, Mic, Globe, Search, Sparkles } from "lucide-react";
                ...
                <div className="relative bg-card border border-border rounded-2xl shadow-lg ring-1 ring-white/5 overflow-hidden transition-all focus-within:ring-orange-500/50">
                    ...
                    <div className="flex items-center justify-between px-4 pb-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button className="p-2 rounded-lg hover:bg-muted text-muted-foreground transition-colors" title="Attach">
                                <Paperclip className="w-5 h-5" />
                            </button>
                            <button className="flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-tr from-orange-500 to-orange-600 text-white shadow-lg hover:shadow-orange-500/25 hover:scale-105 transition-all active:scale-95">
